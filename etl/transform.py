...
class DataTransformer():
    ...
    def transform_data(self, df):
        if df['info'].apply(lambda x: x['gameMode'] in ["URF", "NEXUSBLITZ", "STRAWBERRY"]).any():
            self.log.info("Skipping transformation for game modes 'URF', 'NEXUSBLITZ' and 'Strawberry'")
            return df  # 
